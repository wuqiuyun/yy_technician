...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    private void initData() {
        ...
        if (mHotCities == null || mHotCities.isEmpty()) {
            ...
            mHotCities.add(new HotCity("北京", "110000"));
            mHotCities.add(new HotCity("上海", "310000"));
            mHotCities.add(new HotCity("广州", "440100"));
            mHotCities.add(new HotCity("深圳", "440300"));
            mHotCities.add(new HotCity("杭州", "330100"));
        }
