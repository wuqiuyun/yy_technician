...
public class ImageLoaderConfig {
    ...
    private float cornerRadius; //圆角角度
    ...
    public static class Builder {
        ...
        private DiskCache diskCacheStrategy = DiskCache.ALL;//设置缓存全部尺寸的图片
        private LoadPriority priority = LoadPriority.HIGH;//优先级为高
        ...
        public Builder setPrioriy(LoadPriority priority) {
            this.priority = priority;
            return this;
        }
    ...
    public static Builder parseBuilder(ImageLoaderConfig config) {
        ...
        builder.cornerRadius = config.cornerRadius;
        return builder;
    }
