...
import com.yl.technician.component.amap.marker.MarkerBuilder;
import com.yl.technician.component.amap.marker.MarkerHelper;
...
public abstract class BaseMapFragment<V extends IBaseView, P extends BasePresenter<V>> extends BaseMvpFragment<V, P>
        implements AMap.OnMarkerClickListener, AMapLocationListener {
    ...
    public LatLng getLastLatLng() {
        return locationPresenter == null
               ? null
               : locationPresenter.getLastLatLng();
    }
    ...
    protected void addMarkers(MarkerBuilder builder) {
        if (aMap == null || builder == null || builder.getDatas() == null || builder.getDatas()
                                                                                    .isEmpty())
        {
            return;
        }
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        ...
        if (aMapLocation.getErrorCode() == 0) {
            ...
            DLog.d("定位信息， getPoiName: " + aMapLocation.getPoiName() + " Lat: " + aMapLocation.getLatitude() + " Lot: " +
                           "" + aMapLocation.getLatitude() + " Speed: " + aMapLocation.getSpeed());
        }else {
