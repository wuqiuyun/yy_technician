...
public class SPfUtils {
    private static final String name = "yl_store";
    ...
    public static void remove(String key) {
        SharedPreferences sp = YLApplication.getContext().getSharedPreferences(name, Context.MODE_PRIVATE);
    ...
    private static <T> T getValue(String key, Class<T> clazz, SharedPreferences sp) {
        ...
        try {
            ...
            e.printStackTrace();
            DLog.e("system", "类型输入错误或者复杂类型无法解析[" + e.getMessage() + "]");
        } catch (IllegalAccessException e) {
            e.printStackTrace();
            DLog.e("system", "类型输入错误或者复杂类型无法解析[" + e.getMessage() + "]");
        }
        DLog.e("system", "无法找到" + key + "对应的值");
        return null;
    }
