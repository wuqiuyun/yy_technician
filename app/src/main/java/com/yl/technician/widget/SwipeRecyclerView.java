...
import com.yl.technician.module.home.service.combo.multiterm.MultitermComboAdapter;
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if (item != null) {
                    //获取当前选中的Item
                    MultitermComboAdapter.MultitermComboHolder viewHolder = (MultitermComboAdapter.MultitermComboHolder) getChildViewHolder(item);
                    mCurItemLayout = (LinearLayout) viewHolder.itemView;
                    //找到具体元素（这与实际业务相关了~~）
