package com.yl.technician.module.im.voicecall;
...
public class VoiceCallActivity extends CallActivity implements View.OnClickListener {
    ...
    protected void init() {
        super.init();
        EasyHelper.getInstance().isVoiceCalling = true;
        callType = 0;
...
//                                        callStateTextView.setText(st7);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_mute:
                if (isMuteState) {
                    muteImage.setImageResource(R.drawable.im_icon_mute_normal);
                    try {
                    ...
                    muteImage.setImageResource(R.drawable.im_icon_mute_on);
                    try {
            ...
            case R.id.iv_handsfree:
                if (isHandsfreeState) {
                    handsFreeImage.setImageResource(R.drawable.im_icon_speaker_normal);
                    closeSpeakerOn();
                    isHandsfreeState = false;
                } else {
                    handsFreeImage.setImageResource(R.drawable.im_icon_speaker_on);
                    openSpeakerOn();
    ...
    protected void onDestroy() {
        EasyHelper.getInstance().isVoiceCalling = false;
        stopMonitor();
        super.onDestroy();
    }
