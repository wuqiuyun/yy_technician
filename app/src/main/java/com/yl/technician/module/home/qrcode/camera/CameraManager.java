...
package com.yl.technician.module.home.qrcode.camera;
...
//    }
    ...
    /*切换闪光灯*/
    public void switchFlashLight(ScancodeActivityHandler handler) {
        ...
        if (flashMode.equals(Camera.Parameters.FLASH_MODE_TORCH)) {
            ...
            msg.what = ZxingConstant.FLASH_CLOSE;


        } else {
            /*打开闪光灯*/
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
            msg.what = ZxingConstant.FLASH_OPEN;
        }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        int setInt=(width-rect.width())/2;//调整该数值调整灵敏度
        ...
        if (config.isFullScreenScan()) {
            ...
            return new PlanarYUVLuminanceSource(data, width, height, 0,
                    rect.top-setInt, width, rect.height()+setInt, false);
        }
