...
public class ImVoiceRecorderView extends RelativeLayout {
    ...
    public ImVoiceRecorderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ImVoiceRecorderView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        voiceRecorder = new ImVoiceRecorder(micImageHandler);
    ...
    public boolean onPressToSpeakBtnTouch(View v, MotionEvent event, EaseVoiceRecorderCallback recorderCallback) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                try {
                    ImChatRowVoicePlayer voicePlayer = ImChatRowVoicePlayer.getInstance(context);
    ...
    public void showReleaseToCancelHint() {
        ...
        recordingHint.setBackgroundResource(R.drawable.im_recording_text_hint_bg);
    }
