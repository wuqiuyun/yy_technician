...
public abstract class CallActivity extends BaseAppCompatActivity {
...
//                        }
    ...
    protected void saveCallRecord() {
        ...
        EventBus.getDefault().post(new EventBean.VoiceCallEventBean(Constants.REQUEST_CODE_VOICE_CALL));
