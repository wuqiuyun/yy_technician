...
public class EmotionUtils {
    ...
    static {
        ...
        EMOTION_CLASSIC_MAP.put("[防毒面具]", R.drawable.d_fangdumianju);
        ...
        EMOTION_CLASSIC_MAP.put("[钱]", R.drawable.d_qian);
        EMOTION_CLASSIC_MAP.put("[神兽]", R.drawable.d_shenshou);
        EMOTION_CLASSIC_MAP.put("[旅行]", R.drawable.d_travel);
        EMOTION_CLASSIC_MAP.put("[神兽]", R.drawable.d_shenshou);
    }
