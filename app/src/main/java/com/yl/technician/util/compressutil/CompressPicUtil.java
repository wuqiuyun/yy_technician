...
public class CompressPicUtil implements Handler.Callback {
    private static final String TAG = "CompressPicUtil";
    ...
    private CompressPicUtil(Builder builder) {
    ...
    public static Builder with() {
        return new Builder(YLApplication.getContext())
                .ignoreBy(100)
                .setTargetDir(FilePathUtil.getCompressPath())
    ...
    public static class Builder {
        ...
        private CompressPicUtil build() {
            return new CompressPicUtil(this);
        }
